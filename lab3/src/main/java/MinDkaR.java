...
public class MinDkaR {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (List<String> ulazi : listaUlaznih) {
            ...
            dohvatiEpsilon(trenutnoStanje,trenutniStog,prijelazi,
                    stog,stanje,sbIzlaz,0,5,
                    prihvatljivaStanja);
            ...
            for (int i = 0; i < ulazi.size(); i++) {
                ...
                if (prijelazi.containsKey(trojka)) {
                    ...
                    if (stog1.equals("$") ){
                        ...
                        trenutniStog = stog1 + trenutniStog.substring(1);
                    }
                    ...
                    dohvatiEpsilon(trenutnoStanje,trenutniStog,prijelazi,
                            stog,stanje,sbIzlaz,i,
                            ulazi.size(),prihvatljivaStanja);
                    trenutnoStanje = stanje.get(stanje.size()-1);
                    trenutniStog = stog.get(stog.size()-1);
                    imaPrijelaz = true;
    ...
    private static void dohvatiEpsilon(String trenutnoStanje, String trenutniStog, Map<TrojkaStanjeZnakStog, ParStanjeStog> prijelazi, List<String> stog, List<String> stanje,StringBuilder sbIzlaz,int i ,int size_ulaz , List<String> prihvatljivaStanja) {
        ...
        if (prijelazi.containsKey(trojka)) {
            ...
            dohvatiEpsilon(trenutnoStanje,trenutniStog,prijelazi,stog,stanje ,sbIzlaz,i,size_ulaz,prihvatljivaStanja);

        }

    }

    //private static void funckijaZaEpsilone(Map<StanjeZnakStog, List<String>> zadaniPrijelazi,
    //                                           Set<String> epsilonPrijelazi, String trenutnoStanje,
    //                                           List<String> listaStanja, String trenutniZnakStoga,
    //                                           List<String> listaZnakovaStoga, StringBuilder stringBuilder,
    //                                           String[] prihvatljivaStanja, int i, int velicinaUlaza)
